            ...
            <div class="card text-center shadow-lg">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled">
                        <li><i class="fas fa-syringe"></i> Revisar y actualizar el inventario de vacunas.</li>
                        <li><i class="fas fa-notes-medical"></i> Consultar las citas programadas para hoy.</li>
                        <li><i class="fas fa-user-md"></i> Acceder a los resultados médicos de los pacientes.</li>
                        <li><i class="fas fa-chart-line"></i> Generar facturas sobre los servicios.</li>
                    </ul>
